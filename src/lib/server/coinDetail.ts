...
const rawCoinDetailSchema = z
  .object({
    ...
    market_data: z.object({
      ...
      high_24h: z.object({ usd: z.number() }).optional(),
      low_24h: z.object({ usd: z.number() }).optional(),
      ath: z.object({ usd: z.number() }),
      ath_change_percentage: z.object({ usd: z.number() }).optional(),
  ...
  .transform(
    (raw): CoinDetail => ({
      ...
      marketCapChangePercentage24h: raw.market_data.market_cap_change_percentage_24h,
